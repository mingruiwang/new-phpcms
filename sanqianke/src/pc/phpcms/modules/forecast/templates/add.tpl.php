...
<body>
<form action="?m=forecast&c=forecast&a=insert&pc_hash=<?php echo $hash?>" method="post">
    <ul>
        ...
        <li>预告名称:<input type="text" name="title" placeholder="title"></li>
        <li> 预告时间:<input type="text" name="starttime" placeholder=""></li>
        <li>预告人名:<input type="text" name="owner" placeholder=""></li>
        <li>预告地址:<input type="text" name="url" placeholder=""></li>
        <li>观看人数:<input type="text" name="audience" placeholder=""></li>
        <li>预告分类:<input type="text" name="category" placeholder=""></li>
</ul>
   &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
