...
<table align="center"width="100%" cellspacing="0">
     <a href="?m=forecast&c=forecast&a=add&pc_hash=<?php echo $hash?>">添加直播</a>
    <tr>
        ...
        <th width="10%" align="center">直播地址</th>
        <th width="10%" align="left">直播分类</th>
        ...
        foreach ($row as $value)
        {
            ...
            echo "<td width='10%'>{$value['url']}</td>";
            echo "<td width='10%'>{$value['category']}</td>";
            echo "<td width='10%'>{$value['audience']}</td>";
            echo "<td width='10%'><a href='?m=forecast&c=forecast&a=edit&id={$value[id]}&pc_hash={$hash}'>修改</a></td>";
            echo "<td width='10%'><a href='?m=forecast&c=forecast&a=delete&id={$value[id]}&pc_hash={$hash}'>删除</a></td>";
            echo '</tr>';
        }
        ?>
