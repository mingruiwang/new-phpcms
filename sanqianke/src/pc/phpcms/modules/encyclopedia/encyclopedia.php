...
class encyclopedia extends admin{
   function __construct()
   {
       parent::__construct();
       $this->db = pc_base::load_model('encyclopedia_model');
   }
    ...
    function insert()
    {
        ...
        showmessage("添加成功","?m=encyclopedia&c=encyclopedia&a=init");
    ...
    function  delete()
    {
        ...
        showmessage("删除成功","?m=encyclopedia&c=encyclopedia&a=init");
    }
